namespace FluentFunctionalCoding.FluentPreludes
{
    public static partial class PreludeFluent
    {
        ...
        public static Try<S, R, E> Try<S, R, E>(this S subject, Func<S, R> funcToTry, Func<S, Exception, E> onCatchFunc, int numRetry = 1)
        ...
        /// <param name="numRetry">The number of times to retry on failure (default is 1).</param>
        /// <returns>A Try representing either success or failure.</returns>
        public static Try<S, Nothing, E> Try<S, E>(this S subject, Action<S> actionToTry, Func<S, Exception, E> onCatchFunc, int numRetry = 1)
        ...
        public static Try<S, R, Nothing> Try<S, R>(this S subject, Func<S, R> funcToTry, Action<S, Exception> onCatchAction, int numRetry = 1)
        ...
        /// <param name="numRetry">The number of times to retry on failure (default is 1).</param>
        /// <returns>A Try representing either success or failure with Nothing as error type.</returns>
        public static Try<S, Nothing, Nothing> Try<S>(this S subject, Action<S> actionToTry, Action<S, Exception> onCatchAction, int numRetry = 1)
        ...
        public static Try<S, R, Exception> Try<S, R>(this S subject, Func<S, R> funcToTry, int numRetry = 1)
        ...
        /// <param name="numRetry">The number of times to retry on failure (default is 1).</param>
        /// <returns>A Try representing either success or failure with Exception as error type.</returns>
        public static Try<S, Nothing, Exception> Try<S>(this S subject, Action<S> actionToTry, int numRetry = 1)
